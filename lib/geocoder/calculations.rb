...
module Geocoder
  module Calculations
    ...
    def to_kilometers(mi)
      Geocoder.log(:warn,
        'DEPRECATION WARNING: Geocoder::Calculations.to_kilometers is deprecated and will be removed in Geocoder 1.5.0. Please multiply by MI_IN_KM instead.')
      mi * mi_in_km
    end
    ...
    def to_miles(km)
      Geocoder.log(:warn,
        'DEPRECATION WARNING: Geocoder::Calculations.to_miles is deprecated and will be removed in Geocoder 1.5.0. Please multiply by KM_IN_MI instead.')
      km * KM_IN_MI
    end
    ...
    def to_nautical_miles(km)
      Geocoder.log(:warn,
        'DEPRECATION WARNING: Geocoder::Calculations.to_nautical_miles is deprecated and will be removed in Geocoder 1.5.0. Please multiply by KM_IN_NM instead.')
      km * KM_IN_NM
    end
    ...
    def km_in_mi
      Geocoder.log(:warn,
        'DEPRECATION WARNING: Geocoder::Calculations.km_in_mi is deprecated and will be removed in Geocoder 1.5.0. Please use the constant KM_IN_MI instead.')
      KM_IN_MI
    end
    ...
    def km_in_nm
      Geocoder.log(:warn,
        'DEPRECATION WARNING: Geocoder::Calculations.km_in_nm is deprecated and will be removed in Geocoder 1.5.0. Please use the constant KM_IN_NM instead.')
      KM_IN_NM
    end
    ...
    def mi_in_km
      Geocoder.log(:warn,
        'DEPRECATION WARNING: Geocoder::Calculations.mi_in_km is deprecated and will be removed in Geocoder 1.5.0. Please use 1.0 / KM_IN_MI instead.')
      1.0 / KM_IN_MI
    end
    ...
    def nm_in_km
      Geocoder.log(:warn,
        'DEPRECATION WARNING: Geocoder::Calculations.nm_in_km is deprecated and will be removed in Geocoder 1.5.0. Please use 1.0 / KM_IN_NM instead.')
      1.0 / KM_IN_NM
    end
    ...
    def extract_coordinates(point)
      ...
      when String
        ...
        if point.respond_to?(:to_coordinates) && (array = point.to_coordinates.is_a?(Array))
