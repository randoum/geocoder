...
class IpstackTest < GeocoderTestCase
  ...
  def test_nested_api_fields
    ...
    assert_equal 5_368_361, result.location['geoname_id']
    ...
    assert_equal 25_876, result.connection['asn']
  ...
  def test_api_request_adds_access_key
    ...
    assert_match 'http://api.ipstack.com/74.200.247.59?access_key=123',
      lookup.query_url(Geocoder::Query.new('74.200.247.59'))
  end
  ...
  def test_uses_lookup_specific_configuration
    ...
    lookup = Geocoder::Lookup.get(:ipstack)
    assert_match 'http://api.ipstack.com/74.200.247.59?access_key=345',
      lookup.query_url(Geocoder::Query.new('74.200.247.59'))
  end
