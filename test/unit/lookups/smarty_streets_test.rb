...
class SmartyStreetsTest < GeocoderTestCase
  ...
  def test_query_for_address_geocode
    ...
    assert_match(%r{api\.smartystreets\.com/street-address\?}, query.url)
  end

  def test_query_for_zipcode_geocode
    query = Geocoder::Query.new('22204')
    assert_match(%r{us-zipcode\.api\.smartystreets\.com/lookup\?}, query.url)
  end
  ...
  def test_query_for_international_geocode
    ...
    assert_match(%r{international-street\.api\.smartystreets\.com/verify\?}, query.url)
  end
