...
if configs.keys.include? ENV['DB']
  ...
  db_name = ENV['DB']
  if db_name == 'sqlite' && ENV['USE_SQLITE_EXT'] == '1'
    gem 'sqlite_ext'
    require 'sqlite_ext'
...
module Geocoder
  module Lookup
    class Base
      ...
      alias actual_make_api_request make_api_request
      ...
      def make_api_request(query)
        ...
        return MockHttpResponse.new(body: 'invalid json', code: 200) if query.text == 'invalid_json'
    ...
    class MaxmindLocal
      ...
      def results(query)
        ...
        if query.to_s == '127.0.0.1'
          ...
          [{ request: '8.8.8.8', ip: '8.8.8.8', country_code2: 'US', country_code3: 'USA',
             country_name: 'United States', continent_code: 'NA', region_name: 'CA', city_name: 'Mountain View', postal_code: '94043', latitude: 37.41919999999999, longitude: -122.0574, dma_code: 807, area_code: 650, timezone: 'America/Los_Angeles' }]
        end
      end
    end
...
class GeocoderTestCase < Test::Unit::TestCase
  ...
  def set_api_key!(lookup_name)
    ...
    key = if lookup.required_api_key_parts.size == 1
            'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
          elsif lookup.required_api_key_parts.size > 1
            lookup.required_api_key_parts
          end
